...
namespace SpaceExplorers
{
    static class EntityLibrary
    {
        ...
        public static void Initialize()
        {
            ...
            Polygon boundsRiver = new Polygon();
            boundsRiver.Points.Add(new Vector(1112, 46));
            boundsRiver.Points.Add(new Vector(1178, 93));
            boundsRiver.Points.Add(new Vector(1180, 110));
            boundsRiver.Points.Add(new Vector(1166, 116));
            boundsRiver.Points.Add(new Vector(1159, 127));
            boundsRiver.Points.Add(new Vector(1161, 138));
            boundsRiver.Points.Add(new Vector(1168, 144));
            boundsRiver.Points.Add(new Vector(1172, 173));
            boundsRiver.Points.Add(new Vector(1140, 187));
            boundsRiver.Points.Add(new Vector(1130, 198));
            boundsRiver.Points.Add(new Vector(1129, 210));
            boundsRiver.Points.Add(new Vector(1089, 235));
            boundsRiver.Points.Add(new Vector(1087, 249));
            boundsRiver.Points.Add(new Vector(1104, 269));
            boundsRiver.Points.Add(new Vector(1168, 297));
            boundsRiver.Points.Add(new Vector(1181, 299));
            boundsRiver.Points.Add(new Vector(1188, 312));
            boundsRiver.Points.Add(new Vector(1180, 334));
            boundsRiver.Points.Add(new Vector(1191, 358));
            boundsRiver.Points.Add(new Vector(1231, 376));
            boundsRiver.Points.Add(new Vector(1294, 382));
            boundsRiver.Points.Add(new Vector(1387, 444));
            boundsRiver.Points.Add(new Vector(1380, 541));
            boundsRiver.Points.Add(new Vector(1356, 565));
            boundsRiver.Points.Add(new Vector(1356, 572));
            boundsRiver.Points.Add(new Vector(1376, 588));
            boundsRiver.Points.Add(new Vector(1382, 602));
            boundsRiver.Points.Add(new Vector(1354, 623));
            boundsRiver.Points.Add(new Vector(1353, 639));
            boundsRiver.Points.Add(new Vector(1372, 659));
            boundsRiver.Points.Add(new Vector(1373, 669));
            boundsRiver.Points.Add(new Vector(1344, 698));
            boundsRiver.Points.Add(new Vector(1281, 737));
            boundsRiver.Points.Add(new Vector(1211, 739));
            boundsRiver.Points.Add(new Vector(1174, 720));
            boundsRiver.Points.Add(new Vector(1140, 713));
            boundsRiver.Points.Add(new Vector(1075, 712));
            boundsRiver.Points.Add(new Vector(1044, 732));
            boundsRiver.Points.Add(new Vector(1030, 752));
            boundsRiver.Points.Add(new Vector(995, 773));
            boundsRiver.Points.Add(new Vector(973, 775));
            boundsRiver.Points.Add(new Vector(924, 793));
            boundsRiver.Points.Add(new Vector(868, 790));
            boundsRiver.Points.Add(new Vector(852, 798));
            boundsRiver.Points.Add(new Vector(824, 802));
            boundsRiver.Points.Add(new Vector(775, 816));
            boundsRiver.Points.Add(new Vector(729, 840));
            boundsRiver.Points.Add(new Vector(703, 865));
            boundsRiver.Points.Add(new Vector(701, 877));
            boundsRiver.Points.Add(new Vector(687, 891));
            boundsRiver.Points.Add(new Vector(684, 914));
            boundsRiver.Points.Add(new Vector(672, 938));
            boundsRiver.Points.Add(new Vector(661, 950));
            boundsRiver.Points.Add(new Vector(627, 970));
            boundsRiver.Points.Add(new Vector(617, 983));
            boundsRiver.Points.Add(new Vector(591, 1000));
            boundsRiver.Points.Add(new Vector(2000, 1000));
            boundsRiver.Points.Add(new Vector(2000, 0));
            RoomEntity riverBounds = new RoomEntity("RiverBounds", new Vector(2000, 1000), null);
            riverBounds.SetCollisionBounds(boundsRiver);
            riverBounds.Immobile = true;
            Entities.Add(riverBounds.GetID(), riverBounds);

            Polygon boundsVertMapBoundary = new Polygon();
            boundsVertMapBoundary.Points.Add(new Vector(0, 0));
            boundsVertMapBoundary.Points.Add(new Vector(-1, 0));
            boundsVertMapBoundary.Points.Add(new Vector(0, 1000));
            RoomEntity vertMapBoundary = new RoomEntity("VertMapBoundary", new Vector(1, 1000), null);
            vertMapBoundary.SetCollisionBounds(boundsVertMapBoundary);
            vertMapBoundary.Immobile = true;
            Entities.Add(vertMapBoundary.GetID(), vertMapBoundary);
            ...
            Polygon zBoundBeaconWire = new Polygon();
            zBoundBeaconWire.Points.Add(new Vector(0, 1));
            zBoundBeaconWire.Points.Add(new Vector(732, 1));
            zBoundBeaconWire.Points.Add(new Vector(732, 0));
            zBoundBeaconWire.Points.Add(new Vector(0, 0));
            ...
            NuclearBeaconWire.ZBound = zBoundBeaconWire;
            ...
            Polygon collisionBoundsGottfried = new Polygon();
            collisionBoundsGottfried.Points.Add(new Vector(17, 43));
            collisionBoundsGottfried.Points.Add(new Vector(17, 49));
            collisionBoundsGottfried.Points.Add(new Vector(32, 49));
            collisionBoundsGottfried.Points.Add(new Vector(32, 43));
            collisionBoundsGottfried.BuildEdges();
            TextureLibrary.Textures.Add("SA EGottfried.png", new Texture(new Image("Images\\SA EGottfried.png")));
            TextureLibrary.Textures.Add("SA EGottfried portrait.png", new Texture(new Image("Images\\SA EGottfried portrait.png")));
            Actor EGottfried = new Actor("EGottfried", "Elke Gottfried", new Vector(50, 50), "SA EGottfried.png", "SA EGottfried portrait.png", 2);
            if ((anim = AnimationLibrary.Create("EGottfriedIdleE")) != null) EGottfried.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("EGottfriedIdleW")) != null) EGottfried.AddAnimation(anim.Type, anim);
            EGottfried.SetCollisionBounds(collisionBoundsGottfried);
            Entities.Add(EGottfried.GetID(), EGottfried);

            Polygon collisionBoundsTel = new Polygon();
            collisionBoundsTel.Points.Add(new Vector(19, 45));
            collisionBoundsTel.Points.Add(new Vector(19, 49));
            collisionBoundsTel.Points.Add(new Vector(33, 49));
            collisionBoundsTel.Points.Add(new Vector(33, 45));
            collisionBoundsTel.BuildEdges();
            TextureLibrary.Textures.Add("Cave Tel.png", new Texture(new Image("Images\\Cave Tel.png")));
            TextureLibrary.Textures.Add("Cave Tel portrait.png", new Texture(new Image("Images\\Cave Tel portrait.png")));
            Actor Tel = new Actor("Tel", "Tel", new Vector(50, 50), "Cave Tel.png", "Cave Tel portrait.png", 2);
            if ((anim = AnimationLibrary.Create("TelIdleE")) != null) Tel.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("TelIdleW")) != null) Tel.AddAnimation(anim.Type, anim);
            Tel.SetCollisionBounds(collisionBoundsTel);
            Entities.Add(Tel.GetID(), Tel);

            Polygon collisionBoundsDevlin = new Polygon();
            collisionBoundsDevlin.Points.Add(new Vector(17, 45));
            collisionBoundsDevlin.Points.Add(new Vector(17, 49));
            collisionBoundsDevlin.Points.Add(new Vector(38, 49));
            collisionBoundsDevlin.Points.Add(new Vector(38, 45));
            collisionBoundsDevlin.BuildEdges();
            TextureLibrary.Textures.Add("NP EDevlin.png", new Texture(new Image("Images\\NP EDevlin.png")));
            TextureLibrary.Textures.Add("NP EDevlin portrait.png", new Texture(new Image("Images\\NP EDevlin portrait.png")));
            Actor EDevlin = new Actor("EDevlin", "Ernie Devlin", new Vector(50, 50), "NP EDevlin.png", "NP EDevlin portrait.png", 2);
            if ((anim = AnimationLibrary.Create("EDevlinIdleE")) != null) EDevlin.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("EDevlinIdleW")) != null) EDevlin.AddAnimation(anim.Type, anim);
            EDevlin.SetCollisionBounds(collisionBoundsDevlin);
            Entities.Add(EDevlin.GetID(), EDevlin);

            Polygon collisionBoundsBelmonte = new Polygon();
            collisionBoundsBelmonte.Points.Add(new Vector(17, 45));
            collisionBoundsBelmonte.Points.Add(new Vector(17, 49));
            collisionBoundsBelmonte.Points.Add(new Vector(38, 49));
            collisionBoundsBelmonte.Points.Add(new Vector(38, 45));
            collisionBoundsBelmonte.BuildEdges();
            TextureLibrary.Textures.Add("HoM JBelmonte.png", new Texture(new Image("Images\\HoM JBelmonte.png")));
            TextureLibrary.Textures.Add("HoM JBelmonte portrait.png", new Texture(new Image("Images\\HoM JBelmonte portrait.png")));
            Actor JBelmonte = new Actor("JBelmonte", "Jayne Belmonte", new Vector(50, 50), "HoM JBelmonte.png", "HoM JBelmonte portrait.png", 2);
            if ((anim = AnimationLibrary.Create("JBelmonteIdleE")) != null) JBelmonte.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("JBelmonteIdleW")) != null) JBelmonte.AddAnimation(anim.Type, anim);
            JBelmonte.SetCollisionBounds(collisionBoundsBelmonte);
            Entities.Add(JBelmonte.GetID(), JBelmonte);

            Polygon collisionBoundsNand = new Polygon();
            collisionBoundsNand.Points.Add(new Vector(19, 44));
            collisionBoundsNand.Points.Add(new Vector(19, 50));
            collisionBoundsNand.Points.Add(new Vector(33, 50));
            collisionBoundsNand.Points.Add(new Vector(33, 44));
            collisionBoundsNand.BuildEdges();
            TextureLibrary.Textures.Add("Chef ANand.png", new Texture(new Image("Images\\Chef ANand.png")));
            TextureLibrary.Textures.Add("Chef ANand portrait.png", new Texture(new Image("Images\\Chef ANand portrait.png")));
            Actor ANand = new Actor("ANand", "Anibel Nand", new Vector(50, 50), "Chef ANand.png", "Chef ANand portrait.png", 2);
            if ((anim = AnimationLibrary.Create("ANandIdleE")) != null) ANand.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("ANandIdleW")) != null) ANand.AddAnimation(anim.Type, anim);
            ANand.SetCollisionBounds(collisionBoundsNand);
            Entities.Add(ANand.GetID(), ANand);

            Polygon collisionBoundsAraceli = new Polygon();
            collisionBoundsAraceli.Points.Add(new Vector(18, 44));
            collisionBoundsAraceli.Points.Add(new Vector(18, 50));
            collisionBoundsAraceli.Points.Add(new Vector(32, 50));
            collisionBoundsAraceli.Points.Add(new Vector(32, 44));
            collisionBoundsAraceli.BuildEdges();
            TextureLibrary.Textures.Add("Sgt CAraceli.png", new Texture(new Image("Images\\Sgt CAraceli.png")));
            TextureLibrary.Textures.Add("Sgt CAraceli portrait.png", new Texture(new Image("Images\\Sgt CAraceli portrait.png")));
            Actor CAraceli = new Actor("CAraceli", "Claire Araceli", new Vector(50, 50), "Sgt CAraceli.png", "Sgt CAraceli portrait.png", 2);
            if ((anim = AnimationLibrary.Create("CAraceliIdleE")) != null) CAraceli.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("CAraceliIdleW")) != null) CAraceli.AddAnimation(anim.Type, anim);
            CAraceli.SetCollisionBounds(collisionBoundsAraceli);
            Entities.Add(CAraceli.GetID(), CAraceli);

            Polygon collisionBoundsRiber = new Polygon();
            collisionBoundsRiber.Points.Add(new Vector(19, 41));
            collisionBoundsRiber.Points.Add(new Vector(19, 48));
            collisionBoundsRiber.Points.Add(new Vector(35, 48));
            collisionBoundsRiber.Points.Add(new Vector(35, 41));
            collisionBoundsRiber.BuildEdges();
            TextureLibrary.Textures.Add("AP ARiber.png", new Texture(new Image("Images\\AP ARiber.png")));
            TextureLibrary.Textures.Add("AP ARiber portrait.png", new Texture(new Image("Images\\AP ARiber portrait.png")));
            Actor ARiber = new Actor("ARiber", "Alexis Riber", new Vector(50, 50), "AP ARiber.png", "AP ARiber portrait.png", 2);
            if ((anim = AnimationLibrary.Create("ARiberIdleE")) != null) ARiber.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("ARiberIdleW")) != null) ARiber.AddAnimation(anim.Type, anim);
            ARiber.SetCollisionBounds(collisionBoundsRiber);
            Entities.Add(ARiber.GetID(), ARiber);

            Polygon collisionBoundsHowie = new Polygon();
            collisionBoundsHowie.Points.Add(new Vector(17, 43));
            collisionBoundsHowie.Points.Add(new Vector(17, 48));
            collisionBoundsHowie.Points.Add(new Vector(31, 48));
            collisionBoundsHowie.Points.Add(new Vector(31, 43));
            collisionBoundsHowie.BuildEdges();
            TextureLibrary.Textures.Add("Mec JHowie.png", new Texture(new Image("Images\\Mec JHowie.png")));
            TextureLibrary.Textures.Add("Mec JHowie portrait.png", new Texture(new Image("Images\\Mec JHowie portrait.png")));
            Actor JHowie = new Actor("JHowie", "Jock Howie", new Vector(50, 50), "Mec JHowie.png", "Mec JHowie portrait.png", 2);
            if ((anim = AnimationLibrary.Create("JHowieIdleE")) != null) JHowie.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("JHowieIdleW")) != null) JHowie.AddAnimation(anim.Type, anim);
            JHowie.SetCollisionBounds(collisionBoundsHowie);
            Entities.Add(JHowie.GetID(), JHowie);

            Polygon collisionBoundsIrving = new Polygon();
            collisionBoundsIrving.Points.Add(new Vector(17, 43));
            collisionBoundsIrving.Points.Add(new Vector(17, 50));
            collisionBoundsIrving.Points.Add(new Vector(33, 50));
            collisionBoundsIrving.Points.Add(new Vector(33, 43));
            collisionBoundsIrving.BuildEdges();
            TextureLibrary.Textures.Add("WDT PIrving.png", new Texture(new Image("Images\\WDT PIrving.png")));
            TextureLibrary.Textures.Add("WDT PIrving portrait.png", new Texture(new Image("Images\\WDT PIrving portrait.png")));
            Actor PIrving = new Actor("PIrving", "Peter Irving", new Vector(50, 50), "WDT PIrving.png", "WDT PIrving portrait.png", 2);
            if ((anim = AnimationLibrary.Create("PIrvingIdleE")) != null) PIrving.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("PIrvingIdleW")) != null) PIrving.AddAnimation(anim.Type, anim);
            PIrving.SetCollisionBounds(collisionBoundsIrving);
            Entities.Add(PIrving.GetID(), PIrving);

            Polygon collisionBoundsWrat = new Polygon();
            collisionBoundsWrat.Points.Add(new Vector(15, 44));
            collisionBoundsWrat.Points.Add(new Vector(15, 50));
            collisionBoundsWrat.Points.Add(new Vector(35, 50));
            collisionBoundsWrat.Points.Add(new Vector(35, 44));
            collisionBoundsWrat.BuildEdges();
            TextureLibrary.Textures.Add("Mountain Bandit1 Unarmed.png", new Texture(new Image("Images\\Mountain Bandit1 Unarmed.png")));
            TextureLibrary.Textures.Add("Mountain Bandit1 Portrait.png", new Texture(new Image("Images\\Mountain Bandit1 Portrait.png")));
            Actor Wrat = new Actor("Wrat", "Wrat", new Vector(50, 50), "Mountain Bandit1 Unarmed.png", "Mountain Bandit1 Portrait.png", 2);
            if ((anim = AnimationLibrary.Create("WratIdleE")) != null) Wrat.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("WratIdleW")) != null) Wrat.AddAnimation(anim.Type, anim);
            Wrat.SetCollisionBounds(collisionBoundsWrat);
            Entities.Add(Wrat.GetID(), Wrat);

            Polygon collisionBoundsJCollins = new Polygon();
            collisionBoundsJCollins.Points.Add(new Vector(19, 44));
            collisionBoundsJCollins.Points.Add(new Vector(19, 50));
            collisionBoundsJCollins.Points.Add(new Vector(34, 50));
            collisionBoundsJCollins.Points.Add(new Vector(34, 44));
            collisionBoundsJCollins.BuildEdges();
            TextureLibrary.Textures.Add("Pvt JCollins.png", new Texture(new Image("Images\\Pvt JCollins.png")));
            TextureLibrary.Textures.Add("Pvt JCollins portrait.png", new Texture(new Image("Images\\Pvt JCollins portrait.png")));
            Actor JCollins = new Actor("JCollins", "Jameson Collins", new Vector(50, 50), "Pvt JCollins.png", "Pvt JCollins portrait.png", 2);
            if ((anim = AnimationLibrary.Create("JCollinsIdleE")) != null) JCollins.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("JCollinsIdleW")) != null) JCollins.AddAnimation(anim.Type, anim);
            JCollins.SetCollisionBounds(collisionBoundsJCollins);
            Entities.Add(JCollins.GetID(), JCollins);

            Polygon collisionBoundsMCollins = new Polygon();
            collisionBoundsMCollins.Points.Add(new Vector(21, 44));
            collisionBoundsMCollins.Points.Add(new Vector(21, 49));
            collisionBoundsMCollins.Points.Add(new Vector(32, 49));
            collisionBoundsMCollins.Points.Add(new Vector(32, 44));
            collisionBoundsMCollins.BuildEdges();
            TextureLibrary.Textures.Add("Elec MCollins.png", new Texture(new Image("Images\\Elec MCollins.png")));
            TextureLibrary.Textures.Add("Elec MCollins portrait.png", new Texture(new Image("Images\\Elec MCollins portrait.png")));
            Actor MCollins = new Actor("MCollins", "MashaCollins", new Vector(50, 50), "Elec MCollins.png", "Elec MCollins portrait.png", 2);
            if ((anim = AnimationLibrary.Create("MCollinsIdleE")) != null) MCollins.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("MCollinsIdleW")) != null) MCollins.AddAnimation(anim.Type, anim);
            MCollins.SetCollisionBounds(collisionBoundsMCollins);
            Entities.Add(MCollins.GetID(), MCollins);

            Polygon collisionBoundsAVDoorn = new Polygon();
            collisionBoundsAVDoorn.Points.Add(new Vector(21, 44));
            collisionBoundsAVDoorn.Points.Add(new Vector(21, 49));
            collisionBoundsAVDoorn.Points.Add(new Vector(32, 49));
            collisionBoundsAVDoorn.Points.Add(new Vector(32, 44));
            collisionBoundsAVDoorn.BuildEdges();
            TextureLibrary.Textures.Add("Cpl AVan Doorn Bandaged.png", new Texture(new Image("Images\\Cpl AVan Doorn Bandaged.png")));
            TextureLibrary.Textures.Add("Cpl AVan Doorn Portrait Bandages.png", new Texture(new Image("Images\\Cpl AVan Doorn Portrait Bandages.png")));
            Actor AVDoorn = new Actor("AVDoorn", "Anna Van Doorn", new Vector(50, 50), "Cpl AVan Doorn Bandaged.png", "Cpl AVan Doorn Portrait Bandages.png", 2);
            if ((anim = AnimationLibrary.Create("AVDoornIdleE")) != null) AVDoorn.AddAnimation(anim.Type, anim);
            if ((anim = AnimationLibrary.Create("AVDoornIdleW")) != null) AVDoorn.AddAnimation(anim.Type, anim);
            AVDoorn.SetCollisionBounds(collisionBoundsAVDoorn);
            Entities.Add(AVDoorn.GetID(), AVDoorn);
